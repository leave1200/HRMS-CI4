					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="card-box pd-20 height-50-p" data-bgcolor="#F1975D">
							<div class="progress-box text-center">
								...
								<h5 class="text-white padding-top-10 h5"><i class="icon-copy fa fa-check-square-o" aria-hidden="true" style="font-size: 30px;"></i>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
						<div class="card-box pd-20 height-50-p" data-bgcolor="#F15A9A" >
							<div class="progress-box text-center">
								...
								<h5 class="text-white padding-top-10 h5"><i class="icon-copy fa fa-question-circle" aria-hidden="true" style="font-size: 30px;"></i>
