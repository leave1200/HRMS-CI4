                    ...
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($attendances)): ?>
                            <?php foreach ($attendances as $attendance): ?>
                                <?php
                                        $attendanceName = trim(esc($attendance['name']));
                                        $currentName = trim(esc($currentUserName));
                                        
                                        // Debugging output
                                        echo "Comparing Attendance: $attendanceName with Current User: $currentName<br>";
                                        
                                        if ($attendanceName === $currentName):
                                    ?>
                                <tr>
