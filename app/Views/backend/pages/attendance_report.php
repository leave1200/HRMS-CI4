        ...
        <div style="font-family: Arial, sans-serif; padding: 20px;">
            <div style="display: flex; justify-content: space-between;">
                ...
                <p style="text-align: left;"><i>Civil Service Form No. 48</i></p>
                    ...
                    <p style="text-align: center;margin-top: -60px;"><strong>Regular Days:</strong> ${numberOfDays}</p>
                    <p style="text-align: center;margin-top: -10px;"><strong>Saturdays:</strong> ${numberOfSaturdays}</p>
