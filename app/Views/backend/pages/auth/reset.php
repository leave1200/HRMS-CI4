    ...
    <div class="login-box bg-white box-shadow border-radius-10">
        ...
        <form action="<?= route_to('reset-password-handler', $token) ?>" method="POST">
            ...
            <div class="input-group custom">
                <input type="password" id="new_password" class="form-control form-control-lg" placeholder="New Password" name="new_password" value="<?= set_value('new_password') ?>" required>
            ...
            <?php endif; ?>
            <div class="input-group custom">
                <input type="password" id="confirm_new_password" class="form-control form-control-lg" placeholder="Confirm New Password" name="confirm_new_password" value="<?= set_value('confirm_new_password') ?>" required>
                <div class="input-group-append custom">
                    <span class="input-group-text"><i class="dw dw-padlock1"></i></span>
                </div>
            </div>
