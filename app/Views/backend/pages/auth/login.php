...
<div class="login-box bg-white box-shadow border-radius-10">
    ...
    <form action="<?= esc(route_to('admin.login.handler'), 'attr') ?>" method="POST" id="loginForm">
        ...
        <div class="g-recaptcha" data-sitekey="6LfaHGsqAAAAAO2c4GXxqpOPKhxeTRqQ7FkVeF4m" id="recaptcha-widget" data-callback="enableFormFields" data-size="compact"></div>
...
<script src="https://www.google.com/recaptcha/api.js?render=6Lcmo3oqAAAAAMwM-y9WJ_BPxc3lA6e2uLW0t7tv" async defer></script>
