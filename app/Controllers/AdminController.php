...
class AdminController extends BaseController
{
    ...
    public function updatePersonalPictures() {
        ...
        // Define the full path, using WRITEPATH or FCPATH for absolute paths
        $path = WRITEPATH . 'uploads/users/';  // Adjust as needed
        ...
        if ($file->move($path, $new_filename)) {
            ...
            echo json_encode(['status' => 0, 'msg' => 'Something went wrong while moving the file.']);
        }
    }
