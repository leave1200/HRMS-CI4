...
// }
    ...
    public function fetchPendingResults()
    {
        ...
        foreach ($pendingLeaveApplications as $leave) {
            ...
            $user = $userModel->find($leave['name']); // Assuming `user_id` exists in leave applications table
            
            // Fetch leave type details for la_type
            $leaveType = $leaveTypeModel->find($leave['l_name']); // Assuming `la_type` references leave types table
