    ...
    public function sendPasswordResetLink(){
        ...
        $mailConfig = array(
            ...
            if(sendEmail($mailConfig) ){
                return redirect()->route_to('admin.forget.forms')->with('success','We have emailed your password reset link.');
            }else{
                return redirect()->route_to('admin.forget.forms')->with('fail','Something went wrong');
            }
